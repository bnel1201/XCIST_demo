...
catsim.CommonTools.my_path.add_search_path('experiment_01_PedXCAT/cfg')
catsim.CommonTools.my_path.add_search_path('example_body')
...
phantomCfgPathname = catsim.CommonTools.my_path.find("cfg", "Phantom_male_infant_ref.cfg", "")
cfg = catsim.CatSim.CatSim(phantomCfgPathname)
cfg.phantomGender = "male"
cfg.experimentDirectory = os.path.join(userPath, "experiment_01_PedXCAT")
cfg.phantom.filename = "example_body.json"
